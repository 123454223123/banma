<template>
  <div class="box">
    <div class="li" >
      <router-link to="/" :class="{atv:url =='/'}">
        <van-icon  :class="{atv:url =='/'}" name="wap-home-o" />
        <p>首页</p>
      </router-link>
    </div>
    <div class="li">
      <router-link to="/mudi" :class="{atv:url =='/mudi'}">
        <van-icon :class="{atv:url =='/mudi'}" name="location-o" />
        <p>目的地</p></router-link
      >
    </div>
    <div class="li">
      <router-link to="/dingzhi"   :class="{atv:url=='/dingzhi/siren'}">
        <img
          ...
          alt=""
        />
        <span class="sp"> 定制游</span>
      </router-link>
    </div>

    <div class="li">
      <router-link to="/faxian"   :class="{atv:url=='/faxian'}">
        <van-icon  :class="{atv:url =='/faxian'}" name="search" />
        <p>发现</p>
      </router-link>
    </div>

    <div class="li">
      <router-link to="/login"   :class="{atv:url =='/user',atv:url == '/login'}">
       <van-icon  :class="{atv:url =='/user',atv:url == '/login'}" name="friends-o" />
        <p>我的</p>
      </router-link>
    </div>
  </div>
